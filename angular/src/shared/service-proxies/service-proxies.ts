...
export class ApplicantServiceProxy {
     ...
     * @return Success
     */
    createApplicant(body: CreateApplicantDTO | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Applicant/CreateApplicant";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateApplicant(<any>response_);
                } catch (e) {
    ...
    protected processCreateApplicant(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    setRoleApplicant(input: string | null | undefined): Observable<void> {
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processSetRoleApplicant(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processSetRoleApplicant(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processSetRoleApplicant(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
@Injectable()
export class AppliedJobsServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    getAll(creatorUserId: number | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<AppliedJobListDTOListResultDto> {
        let url_ = this.baseUrl + "/api/services/app/AppliedJobs/GetAll?";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<AppliedJobListDTOListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AppliedJobListDTOListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<AppliedJobListDTOListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AppliedJobListDTOListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AppliedJobListDTOListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    createApplyJob(body: CreateAppliedJob | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AppliedJobs/CreateApplyJob";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processCreateApplyJob(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateApplyJob(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateApplyJob(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteJob(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/AppliedJobs/DeleteJob?";
        if (id === null)
     ...
     * @return Success
     */
    getAppliedJobs(creatorUserId: number | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<AppliedJobListDTOPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/AppliedJobs/GetAppliedJobs?";
        if (creatorUserId === null)
            throw new Error("The parameter 'creatorUserId' cannot be null.");
        else if (creatorUserId !== undefined)
            url_ += "CreatorUserId=" + encodeURIComponent("" + creatorUserId) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetAppliedJobs(<any>response_);
                } catch (e) {
                    return <Observable<AppliedJobListDTOPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<AppliedJobListDTOPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAppliedJobs(response: HttpResponseBase): Observable<AppliedJobListDTOPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = AppliedJobListDTOPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<AppliedJobListDTOPagedResultDto>(<any>null);
    }
}
...
export class JobServiceProxy {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<JobListDTOListResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobListDTOListResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<JobListDTOListResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobListDTOListResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobListDTOListResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    createJob(body: CreateJobInput | undefined): Observable<void> {
     ...
     * @return Success
     */
    updateJob(body: UpdateJobInputDTO | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Job/UpdateJob";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateJob(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
     ...
     */
    deleteJob(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Job/DeleteJob?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
@Injectable()
export class RecruiterServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    createRecruiter(body: CreateRecruiterDTO | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/Recruiter/CreateRecruiter";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processCreateRecruiter(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processCreateRecruiter(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CreateApplicantDTO implements ICreateApplicantDTO {
    ...
    highestQualifcation: string | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.age = _data["age"];
            this.tenthPercentage = _data["tenthPercentage"];
            this.twelthPercentage = _data["twelthPercentage"];
            this.highestQualifcation = _data["highestQualifcation"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["age"] = this.age;
        data["tenthPercentage"] = this.tenthPercentage;
        data["twelthPercentage"] = this.twelthPercentage;
        data["highestQualifcation"] = this.highestQualifcation;
        return data; 
    }
...
export class AppliedJobListDTO implements IAppliedJobListDTO {
    ...
    static fromJS(data: any): AppliedJobListDTO {
        data = typeof data === 'object' ? data : {};
        let result = new AppliedJobListDTO();
        result.init(data);
        return result;
    }
...
export class AppliedJobListDTOListResultDto implements IAppliedJobListDTOListResultDto {
    items: AppliedJobListDTO[] | undefined;

    constructor(data?: IAppliedJobListDTOListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(AppliedJobListDTO.fromJS(item));
            }
        }
    }

    static fromJS(data: any): AppliedJobListDTOListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new AppliedJobListDTOListResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): AppliedJobListDTOListResultDto {
        const json = this.toJSON();
        let result = new AppliedJobListDTOListResultDto();
        result.init(json);
        return result;
...
export interface IAppliedJobListDTOListResultDto {
    items: AppliedJobListDTO[] | undefined;
}

export class CreateAppliedJob implements ICreateAppliedJob {
    jobId: number;

    constructor(data?: ICreateAppliedJob) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateAppliedJob {
        data = typeof data === 'object' ? data : {};
        let result = new CreateAppliedJob();
        result.init(data);
        return result;
    }
...
export interface ICreateAppliedJob {
    jobId: number;
}

export class AppliedJobListDTOPagedResultDto implements IAppliedJobListDTOPagedResultDto {
    totalCount: number;
    items: AppliedJobListDTO[] | undefined;

    constructor(data?: IAppliedJobListDTOPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): AppliedJobListDTOPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new AppliedJobListDTOPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): AppliedJobListDTOPagedResultDto {
        const json = this.toJSON();
        let result = new AppliedJobListDTOPagedResultDto();
        result.init(json);
        return result;
...
export interface IAppliedJobListDTOPagedResultDto {
    totalCount: number;
    items: AppliedJobListDTO[] | undefined;
}
...
export class JobListDTO implements IJobListDTO {
    companyName: string | undefined;
    position: string | undefined;
    eligibility: string | undefined;
    skillsRequired: string | undefined;
    ...
    static fromJS(data: any): JobListDTO {
        data = typeof data === 'object' ? data : {};
        let result = new JobListDTO();
        result.init(data);
        return result;
    }
...
export class JobListDTOListResultDto implements IJobListDTOListResultDto {
    items: JobListDTO[] | undefined;

    constructor(data?: IJobListDTOListResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            if (Array.isArray(_data["items"])) {
                this.items = [] as any;
                for (let item of _data["items"])
                    this.items.push(JobListDTO.fromJS(item));
            }
        }
    }

    static fromJS(data: any): JobListDTOListResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new JobListDTOListResultDto();
        result.init(data);
        return result;
    }
...
export interface IJobListDTOListResultDto {
    items: JobListDTO[] | undefined;
}

export class CreateJobInput implements ICreateJobInput {
    companyName: string | undefined;
    position: string | undefined;
    eligibility: string | undefined;
    skillsRequired: string | undefined;
    ...
    constructor(data?: ICreateJobInput) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateJobInput {
        data = typeof data === 'object' ? data : {};
        let result = new CreateJobInput();
        result.init(data);
        return result;
    }
...
export class UpdateJobInputDTO implements IUpdateJobInputDTO {
    id: number;
    companyName: string | undefined;
    position: string | undefined;
    eligibility: string | undefined;
    ...
    constructor(data?: IUpdateJobInputDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): UpdateJobInputDTO {
        data = typeof data === 'object' ? data : {};
        let result = new UpdateJobInputDTO();
        result.init(data);
        return result;
    }
...
export class JobListDTOPagedResultDto implements IJobListDTOPagedResultDto {
    totalCount: number;
    items: JobListDTO[] | undefined;

    constructor(data?: IJobListDTOPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): JobListDTOPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new JobListDTOPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): JobListDTOPagedResultDto {
        const json = this.toJSON();
        let result = new JobListDTOPagedResultDto();
        result.init(json);
        return result;
...
export interface IJobListDTOPagedResultDto {
    totalCount: number;
    items: JobListDTO[] | undefined;
}

export class CreateRecruiterDTO implements ICreateRecruiterDTO {
    companyName: string | undefined;

    constructor(data?: ICreateRecruiterDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): CreateRecruiterDTO {
        data = typeof data === 'object' ? data : {};
        let result = new CreateRecruiterDTO();
        result.init(data);
        return result;
    }
...
export interface ICreateRecruiterDTO {
    companyName: string | undefined;
}
